...
If the deploy command returns JSON, parse the URL from the result and requestServer that exact public URL. Do not accidentally test `localhost` or `127.0.0.1` instead of public ingress.
